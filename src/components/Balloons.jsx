...
const MESSAGES = [
  "her smile 😊 — it literally lights up the whole room, every single time.",
  "her hair 🌸 — the way it falls just perfectly... okay it's unfair.",
  "her mole 🖤 — that little dot on her face? adorable. no debate.",
  "her dimples 💫 — when she laughs and those appear... game over honestly.",
  "the way she talks 🗣️ — could listen to her all day, no complaints.",
  "just her 🍦 — all of it. every tiny detail. yeah, all of it.",
]
    ...
    <div>
      ...
      {allPopped && (
        <p className="script accent" style={{ textAlign: 'center', fontSize: 28, marginTop: 24,
          ...
          …and a million more things I like about her. 🎈
        </p>
      )}
    </div>
  )
